...
namespace JReact.Tilemaps.Generator
{
    ...
    public class J_MapData : ScriptableObject
    {
        ...
        [BoxGroup("Setup", true, true, 0), SerializeField, AssetsOnly, Required] private Vector2 _mapStart;
        public Vector2 MapStart => _mapStart;
        ...
        [FoldoutGroup("State", false, 5), ReadOnly, ShowInInspector] public int Length => Ground
                                                                                              ? Ground.Length
                                                                                              : 0;
        [FoldoutGroup("State", false, 5), ReadOnly, ShowInInspector] public int Width => Ground
                                                                                             ? Ground.Width
                                                                                             : 0;
        [FoldoutGroup("State", false, 5), ReadOnly, ShowInInspector] public int Height => Ground
                                                                                              ? Ground.Length / Width
                                                                                              : 0;
        ...
        public void Setup()
        {
            ...
            _tileCache = new J_TileInfo[OvergroundLayers.Length];
        }
