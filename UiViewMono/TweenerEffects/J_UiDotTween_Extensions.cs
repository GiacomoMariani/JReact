...
{
    public static class J_UiDotTween_Extensions
    {
        ...
        /// </summary>
        public static Tweener PopOut(this RectTransform rectTransform, Vector3 endScale, float duration, Ease easeType = Ease.OutBounce)
