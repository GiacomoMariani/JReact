...
namespace JReact.J_Input
{
    ...
    public class J_Mono_DraggingAxis : MonoBehaviour, IDragHandler, IEndDragHandler
    {
        ...
        [BoxGroup("Setup", true, true, 0), SerializeField] private Vector2 _resetValue;

        public void OnDrag(PointerEventData eventData)
            => _Axis.Current = new Vector2(eventData.delta.x * _touchSensitivity_x, eventData.delta.y * _touchSensitivity_y);

        public void OnEndDrag(PointerEventData eventData) => _Axis.Current = _resetValue;
    }
}
